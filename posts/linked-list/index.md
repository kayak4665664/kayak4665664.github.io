...
A C&#43;&#43; template for the doubly linked list.
...
Using this method directly resulted in `Time Limit Exceeded`,
```cpp
class Solution {
   public:
...
and I solved it using the priority queue.
```cpp
class Solution {
   public:
    ListNode *mergeKLists(vector&lt;ListNode *&gt; &amp;lists) {
...
> URL: http://localhost:1313/posts/linked-list/  
